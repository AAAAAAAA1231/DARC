...
2. **妖币监控**  
   聚合 GMGN、DexScreener、GeckoTerminal。**生存优先**：池子 **≥ $80,000**；拒绝 1 小时已涨 ≥32%、5 分钟已涨 ≥18%、正在出货、Pump.fun 浅池。避开的币不再出现在列表里。只有「可跟」允许小仓。跟单默认 **8% 止损 / 16% 止盈**，45 分钟未到 +3% 超时离场，最多 2 仓。

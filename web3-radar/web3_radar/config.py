...
DEFAULT_SETTINGS: dict[str, Any] = {
    ...
    "copy_sl_pct": 0.18,
    "copy_tp_pct": 9.0,
    "copy_max_1h_change": 85,
    "copy_min_heat": 68,
    "copy_max_risk": 48,
    "copy_paper_equity": 1000,
    "copy_cooldown_minutes": 150,
    "copy_max_size_pct": 0.01,
    "copy_trail_arm_pct": 0.50,
    "copy_trail_lock_pct": 1.5,
    "copy_daily_loss_pct": 0.06,
    "copy_time_stop_minutes": 50,
    "copy_giveup_pct": 0.12,
    "copy_scale1_mult": 1.5,
    "copy_scale2_mult": 2.5,
    "copy_scale_frac": 0.55,
    "copy_scale2_frac": 0.20,
    "copy_fast_fail_minutes": 12,
    "copy_fast_fail_pct": 0.07,
    "copy_struct_m5_fail": -8,
    "copy_struct_h1_min": 25,
    "copy_require_multi_source": True,
    "weight_refit_days": 7,
}
...
def _apply_meme_rules_upgrade(settings: dict[str, Any]) -> dict[str, Any]:
    ...
    target = int(DEFAULT_SETTINGS.get("meme_rules_version") or 5)

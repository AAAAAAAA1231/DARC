...
DEFAULT_SETTINGS: dict[str, Any] = {
    ...
    "trail_arm_r": 1.5,
    "trail_atr_mult": 1.0,
    "meme_rules_version": 4,
    "meme_min_liquidity_usd": 40_000,
    "meme_buyer_window_minutes": 30,
    "meme_min_unique_buyers": 15,
    "meme_min_holder_growth": 8,
    "meme_max_1h_change": 110,
    "meme_max_m5_change": 28,
    "meme_min_age_minutes": 20,
    ...
    "copy_sl_pct": 0.20,
    "copy_tp_pct": 9.0,
    "copy_max_1h_change": 110,
    "copy_min_heat": 64,
    "copy_max_risk": 55,
    "copy_paper_equity": 1000,
    "copy_cooldown_minutes": 120,
    "copy_max_size_pct": 0.01,
    "copy_trail_arm_pct": 0.60,
    "copy_trail_lock_pct": 2.0,
    "copy_daily_loss_pct": 0.06,
    "copy_time_stop_minutes": 90,
    "copy_giveup_pct": 0.15,
    "copy_scale1_mult": 1.6,
    "copy_scale2_mult": 3.0,
    "copy_scale_frac": 0.45,
    "copy_scale2_frac": 0.25,
    "copy_fast_fail_minutes": 20,
    "copy_fast_fail_pct": 0.10,
    "weight_refit_days": 7,
}
...
def _apply_meme_rules_upgrade(settings: dict[str, Any]) -> dict[str, Any]:
    ...
    target = int(DEFAULT_SETTINGS.get("meme_rules_version") or 4)

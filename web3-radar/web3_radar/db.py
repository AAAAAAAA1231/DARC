        ...
        slim.append(
            {
                ...
                "filter_note": r.get("filter_note"),
                "plan_note": r.get("plan_note"),
                "price": r.get("price"),
                "entry": r.get("entry"),
                "stop_loss": r.get("stop_loss"),
                "take_profit": r.get("take_profit"),
                "partial_tp": r.get("partial_tp"),
                "breakeven": r.get("breakeven"),
                "trail_arm": r.get("trail_arm"),
                "atr_pct": r.get("atr_pct"),
                "sl_mult": r.get("sl_mult"),
                "tp_mult": r.get("tp_mult"),
                "suggested_notional_pct": r.get("suggested_notional_pct"),
                "suggested_risk_pct": r.get("suggested_risk_pct"),
                "mode": r.get("mode") or "",
                "n_sims": r.get("n_sims"),

...
from suanli_budget.config import DEFAULT_HOST, DEFAULT_PORT, STATIC_DIR, ensure_dirs
...
def main() -> None:
    ...
    ensure_dirs()
    parser = argparse.ArgumentParser(description="算力中心预算编制")
    ...
    print("=" * 50, flush=True)
    print("算力中心预算编制正在启动，请不要关闭这个黑窗口。", flush=True)

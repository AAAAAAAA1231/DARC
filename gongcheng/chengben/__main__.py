...
from chengben.config import DEFAULT_HOST, DEFAULT_PORT, STATIC_DIR, ensure_dirs
...
def main() -> None:
    ...
    ensure_dirs()
    parser = argparse.ArgumentParser(description="工程成本 · 跟踪纠偏")
    ...
    print("=" * 50, flush=True)
    print("工程成本正在启动，请不要关闭这个黑窗口。", flush=True)

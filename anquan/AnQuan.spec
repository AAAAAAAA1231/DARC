...
binaries = []
hiddenimports = collect_submodules("anquan") + [
...
pyz = PYZ(a.pure)
exe = EXE(pyz, a.scripts, a.binaries, a.datas, [], name="AnQuan", debug=False, bootloader_ignore_signals=False, strip=False, upx=False, console=True)
